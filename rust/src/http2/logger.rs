...
fn log_http2(tx: &HTTP2Transaction, js: &mut JsonBuilder) -> Result<bool, JsonError> {
    ...
    // Close http2.
    js.close()?;
    let start_time: u64 = tx.start_time as u64;
    let end_time: u64 = tx.end_time as u64;
    js.set_uint("request_start_timestamp", start_time as u64);
    js.set_uint("response_end_timestamp", end_time as u64);
